...
1. Use REST API
    ...
    c.  https://confluence.example.com/rest/api/space/DOCS10/content
    d.  Tiny Example Space: https://confluence.example.com/rest/api/space/TES/content
2. Use export file
...
Simple - https://confluence.example.com/display/DOCS/Sample

	API Call: https://confluence.example.com/rest/api/content/789

Complex - https://confluence.example.com/pages/viewpage.action?pageId=789
